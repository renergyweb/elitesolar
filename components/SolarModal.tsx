...
export default function SolarModal() {
  ...
  const systemInstruction = `Eres Grecia, una asesora solar amigable y experta de la empresa Renergy México en México. Tu objetivo es ayudar a la gente a dejar de pagarle tanto dinero a la CFE.
...
3. Cálculos rápidos (para tu uso interno):
   ...
   - Inversión = $8,500 MXN por panel.
   - Ahorro = 95%.
   - Recuperación = 1 a 4 años.

Flujo de la charla:
- Saluda breve: "¡Hola! Qué gusto saludarte. Soy Grecia de Renergy México. Para darte una idea de cuánto podrías ahorrar, ¿en cuánto te llega más o menos tu recibo de CFE?"
...
- Cierre: Pregúntales si quieren que les mandes el resumen por aquí o si prefieren agendar una vuelta rápida para revisar su domicilio.
...
- Ejemplo: "¡Hola! ¿Cómo estás? [typing] Oye, fíjate que revisé tu caso... [typing] ¿Te parece si agendamos?"`;
  ...
  const handleInitialGreeting = () => {
    setIsLoading(true);
    setTimeout(() => {
      const initialText = "¡Hola! Qué gusto saludarte. Soy Grecia de Renergy México. [typing] Para darte una idea de cuánto podrías ahorrar, ¿en cuánto te llega más o menos tu recibo de CFE?";
            ...
            <div className="relative pt-12 pb-8 flex flex-col items-center justify-center shrink-0 z-10 bg-gradient-to-b from-white to-[#F8FAFC]">
              ...
              <div className="relative">
                ...
                <div className="relative w-28 h-28 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-white shadow-xl mb-4">
                  <Image src="https://i.postimg.cc/PfMpjyF5/avatar-elite-solar.jpg" alt="Grecia - Asesora Solar" fill className="object-cover" referrerPolicy="no-referrer" />
                </div>
                <div className="absolute bottom-4 right-0 w-5 h-5 bg-emerald-500 border-4 border-white rounded-full"></div>
              </div>
              <h2 className="font-bold text-2xl md:text-3xl text-slate-900 tracking-tight mb-1">Grecia</h2>
